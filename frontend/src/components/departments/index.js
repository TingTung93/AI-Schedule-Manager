/**
 * Department Components Barrel Export
 *
 * Centralized export for all department-related components.
 * Usage:
...
export { default as UnassignedEmployeesList } from './UnassignedEmployeesList';
export { default as DepartmentTransferDialog } from './DepartmentTransferDialog';
