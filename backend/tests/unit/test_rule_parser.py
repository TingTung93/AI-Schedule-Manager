...
class TestRuleParser:
    ...
    def parser(self):
        ...
        parser.nlp = Mock()
        parser.nlp.return_value = Mock(text="test rule", ents=[], lower=Mock(return_value="test rule"))
        return parser
    ...
    def test_validate_constraint_valid_time(self, parser):
        ...
        constraint = {"type": "time", "value": "14:30"}
    ...
    def test_validate_constraint_invalid_time(self, parser):
        ...
        constraint = {"type": "time", "value": "25:00"}  # Invalid hour
