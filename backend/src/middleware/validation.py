...
class ValidationMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app, **kwargs):
        ...
        self.allowed_content_types = {"application/json", "application/x-www-form-urlencoded", "multipart/form-data"}
        ...
        self.path_traversal_patterns = [r"\.\./|\.\.\\"]
                ...
                if body:
                    ...
                    if not validation_result["valid"]:
                        return JSONResponse(
                            ...
                            content={"detail": "Invalid request data", "errors": validation_result["errors"]},
                        )
            except Exception as e:
                return JSONResponse(
                    status_code=status.HTTP_400_BAD_REQUEST, content={"detail": f"Invalid request body: {str(e)}"}
                )
...
class InputSanitizer:
    ...
    def sanitize_json(data: Any, max_depth: int = 10) -> Any:
        ...
        if isinstance(data, str):
            ...
            return {
                InputSanitizer.sanitize_json(k, max_depth - 1): InputSanitizer.sanitize_json(v, max_depth - 1)
